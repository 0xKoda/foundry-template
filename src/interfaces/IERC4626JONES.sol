...
abstract contract IERC4626JONES is ERC20 {
    /*///////////////////////////////////////////////////////////////
                                Events
    //////////////////////////////////////////////////////////////*/
...
//withdraws from approved strategy
    function withdrawStrategy(address strategy, uint256 amount) internal virtual returns (uint256 balance);
...
//checks the current window (0 locked, 1 unlocked, 2 Accepting deposits)
    function getWindow() external view virtual returns (uint256);
